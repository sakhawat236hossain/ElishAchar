...
<a
  ...
  className="w-14 h-14 shadow-2xl rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform overflow-hidden"
>
  <img src="https://img.icons8.com/?size=100&id=A1JUR9NRH7sC&format=png&color=000000" alt="WhatsApp" className="w-8 h-8" />
          ...
          <a
            ...
            className="w-14 h-14 cursor-pointer bg-gray-100 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform text-white text-2xl"
          >
